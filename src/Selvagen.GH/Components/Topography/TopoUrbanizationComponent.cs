    ...
    public class TopoUrbanizationComponent : SelvagenModuleComponentBase
    {
        public TopoUrbanizationComponent()
            : base("Topography Urbanization", "TpUr",
                   "Upload topography urbanization data. [Urbanização]", "03 Topography") { }
        ...
        protected override void RegisterInputParams(GH_InputParamManager pManager)
        {
            ...
            pManager.AddTextParameter("Urbanization Curves ID", "UC", "Urbanization curve set asset ID [Curvas de Urbanização]", GH_ParamAccess.item);
